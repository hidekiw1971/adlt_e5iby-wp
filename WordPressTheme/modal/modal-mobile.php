  <!-- modal-mobile -->
  <div class="modal fade" id="modal-mobile" tabindex="-1" role="dialog" aria-label="exampleModalLabel" aria-hidden="true">
      <!-- モーダルのダイヤログ本体 -->
          ...
          <div class="modal-content">
              ...
              <div class="modal-body">
                  ...
                  <ul class="sidebar-nav">
                      ...
                      <!-- sidebar-list -->
                      <li class="sidebar-list">
                          <button type="button" class="btn" data-toggle="modal" data-target="#modal-6" data-dismiss="modal">プライバシーポリシー</button>
                      </li>
                      <!-- /sidebar-list -->
                      <!-- sidebar-list -->
                      <li class="sidebar-list">
